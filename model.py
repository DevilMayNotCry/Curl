...
class CURLLoss(nn.Module):
    ...
    def forward(self, predicted_img_batch, target_img_batch, gradient_regulariser):
        ...
        """
        # print('predicted_img_batch  :  {}  |  target_img_batch  :  {}'.format(predicted_img_batch.shape, target_img_batch.shape))
        ...
        for i in range(0, num_images):
            ...
            # print('target_img  :  {}'.format(target_img.shape))
            # print('predicted_img  :  {}'.format(predicted_img.shape))
...
class CURLNet(nn.Module):
    ...
    def forward(self, img):
        ...
        """
        # print('CURLNet 这里  img  :  {}'.format(img.shape))
        feat = self.tednet(img)
        # print('tednet 之后  :  {}'.format(feat.shape))
        img, gradient_regulariser = self.curllayer(feat)
        # print('curllayer 之后  :  {}'.format(img.shape))
